...
ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --ffi -vvvv
endif

deploy:
	@forge script script/DeployNFTBrabo.s.sol:DeployNFTBrabo $(NETWORK_ARGS)

mint:
	@forge script script/Interactions.s.sol:MintNFTBrabo ${NETWORK_ARGS}
